...
############################# MICE ###############################################
```{r}
rm(list = setdiff(ls(), "dataKNN_test"))
load("C:/Users/miguel.prada.leon/Downloads/data_NA_imputed_MICE_test.RData")
data <- data_imputed_MICE_test
...
############################# AREG ###############################################
```{r}
rm(list = setdiff(ls(), c("dataKNN_test","dataMICE_test")))
load("C:/Users/miguel.prada.leon/Downloads/data_NA_imputed_AREG_test.RData")
